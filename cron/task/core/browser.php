...
class Browser
{
 ...
 /*   function Browser($userAgent = "")
     ...
     */
    static function isBrowser($browserName)
    {
     ...
     */
    static function setBrowser($browser)
    {
     ...
     */
    static function setPlatform($platform)
    {
     ...
     */
    static function setAolVersion($version)
    {
    ...
    */
     ...
     */
    static function setUserAgent($agent_string)
    {
        reset();
        $_agent = $agent_string;
        determine();
